  ...
  return (
    <div className="min-h-screen" data-testid="contact-page">
      ...
      <section className="py-20">
        <div className="container">
          <div className="grid lg:grid-cols-2 gap-12">
            {/* Form */}
            <div className="glass-card p-8 md:p-12 rounded-3xl" data-testid="contact-form">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-6 py-3 rounded-2xl bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 outline-none focus:border-orange-500 transition-colors"
                  />
                </div>
                <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-6 py-3 rounded-2xl bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 outline-none focus:border-orange-500 transition-colors resize-none"
                  ></textarea>
                </div>
                <button
                  type="submit"
              ...
              <div>
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 rounded-2xl bg-gradient-orange-blue flex items-center justify-center flex-shrink-0">
      ...
      <section className="py-20 gradient-subtle">
        <div className="container">
          <h2 className="text-4xl lg:text-5xl font-bold text-center mb-16" data-testid="faq-title">Frequently Asked Questions</h2>
          <div className="max-w-4xl mx-auto space-y-6">
            {faqs.map((faq, index) => (
              <div key={index} className="glass-card p-8 rounded-2xl" data-testid={`faq-${index}`}>
                <div className="flex items-start space-x-4">
      ...
      <section className="h-96 bg-gray-200 dark:bg-gray-800">
        <div className="w-full h-full flex items-center justify-center text-gray-500 dark:text-gray-400">
          <MapPin className="w-16 h-16 mr-4" />
