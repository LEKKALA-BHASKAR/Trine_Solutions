  ...
  return (
    <div className="min-h-screen" data-testid="home-page">
          ...
          <div className="animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link to="/contact" data-testid="get-consultation-btn">
                <button className="btn-ghost border-white text-white hover:bg-white hover:text-deep-blue">
                  Get Consultation
                </button>
              </Link>
            </div>
      ...
      <section className="py-20">
        <div className="container">
          <div className="text-center mb-16">
            <h2 className="text-4xl lg:text-5xl font-bold mb-4" data-testid="case-studies-title">Success Stories</h2>
            <p className="text-lg opacity-80 max-w-2xl mx-auto">
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <Link to="/case-studies" data-testid={`case-study-view-${index}`}>
                    <button className="text-orange-500 font-semibold flex items-center space-x-2">
